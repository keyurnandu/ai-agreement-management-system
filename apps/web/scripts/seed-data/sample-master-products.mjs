...
export const PROCUREMENT_PRODUCTS = [
  {
    ...
    creditsPurchased: 50000000,
    quantity: null,
    unitPrice: 10000.0,
    currency: "USD",
    pricingNotes: "Prepaid tokens · true-up on overage.",
  ...
  },
  {
    ...
    manufacturer: "Anthropic Technologies, LLC",
    family: "AI Platform",
    pricingModel: "LICENSED",
    creditsPurchased: null,
    quantity: 1,
    unitPrice: null,
    currency: "USD",
    pricingNotes: "Business-hours support · bundled with the token commitment.",
    validFrom: "2026-02-01",
    validUntil: "2027-01-31",
    sourceCommercialId: "POR-1",
  },
  ...
  for (const p of PROCUREMENT_PRODUCTS) {
    ...
    await prisma.masterProduct.create({
      data: {
        ...
        creditsPurchased: p.creditsPurchased ?? null,
        unitPrice: p.unitPrice,
        currency: p.currency,
        pricingNotes: p.pricingNotes,
        validFrom: p.validFrom ? new Date(p.validFrom) : null,
